                        ...
                        <div class="fn_row okay okay_list_body_item fn_sort_item">
                            <div class="okay_list_row">
                                ...
                                <div class="okay_list_boding okay_list_related_name">
                                    <a class="link" href="{url module=ProductAdmin id=$product->id}">{$product->name|escape}</a>
                                </div>
    ...
    $("input#{$name}_compact_product_list").devbridgeAutocomplete({
        ...
        onSelect:
            function(suggestion){
                ...
                new_item.find('a.compact_list_product_name').attr('href', 'index.php?module=ProductAdmin&id='+suggestion.data.id);
